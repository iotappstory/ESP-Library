...
const char HTTP_PORTAL_OPTIONS[] PROGMEM  = "<a href=\"/wifi\" class=\"btn\">Wifi Config.</a><a href=\"/i\" class=\"btn\">Information</a>{a}{q}<a href=\"/close\" class=\"btn\">Exit Portal</a>";

const char HTTP_PORTAL_IASCFG[] PROGMEM   = "<a href=\"/ias\" class=\"btn\">IOTAppStory Cfg.</a>";
const char HTTP_PORTAL_APPCFG[] PROGMEM   = "<a href=\"/app\" class=\"btn\">App Config.</a>";
